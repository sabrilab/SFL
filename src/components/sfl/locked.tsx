...
export function Locked({
  ...
  return (
    <div className={cn("relative", className)} aria-disabled>
      ...
      <span className="absolute top-3 right-3 z-10 flex items-center gap-1.5 rounded-full bg-foreground/85 px-2.5 py-1 text-[11px] font-bold tracking-wide text-background uppercase">
