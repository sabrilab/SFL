...
export const PLAYERS: Player[] = [
  ...
  { name: "Omar", poste: "MC", pp: 7, matchs: 1, buts: 1, passes: 4, statut: "Blessure", stats: { VIT: 81, TIR: 79, PAS: 85, DRI: 88, DEF: 72, PHY: 64 }, mvp: 0, impact: 0, def: 0 },
  ...
  { name: "Wadi", poste: "AT", pp: 2, matchs: 1, buts: 0, passes: 1, statut: "Suspendu", stats: { VIT: 86, TIR: 80, PAS: 80, DRI: 78, DEF: 80, PHY: 80 }, mvp: 0, impact: 0, def: 0 },
  ...
  { name: "Mehdi", poste: "MDC", pp: 0, matchs: 1, buts: 1, passes: 0, statut: "Suspendu", stats: { VIT: 74, TIR: 73, PAS: 75, DRI: 76, DEF: 83, PHY: 88 }, mvp: 0, impact: 0, def: 0 },
