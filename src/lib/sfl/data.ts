...
// MVP / Impact / Défensive décerné dans la feuille SAISIE MATCH. Base = carte
// rare (« base fixe des cartes boost »), ajustée selon la perf de la journée :
// +buts en TIR, +passes en PAS ; la carte Défensive gagne +2 DEF, +2 PHY et
// +2 VIT (auto). Joueurs non évalués : base neutre 75.
export const BOOST_CARDS: BoostCardData[] = [
  { player: "Kader", type: "mvp", ovr: 83, poste: "MC/AT", date: "J1 · 22 juin", stats: { VIT: 79, TIR: 81, PAS: 83, DRI: 87, DEF: 79, PHY: 85 } },
  { player: "Badis", type: "impact", ovr: 83, poste: "MC/MDC", date: "J1 · 22 juin", stats: { VIT: 78, TIR: 78, PAS: 77, DRI: 78, DEF: 91, PHY: 93 } },
  { player: "Kader", type: "impact", ovr: 83, poste: "MC/AT", date: "J1 · 22 juin", stats: { VIT: 79, TIR: 81, PAS: 83, DRI: 87, DEF: 79, PHY: 85 } },
  { player: "Sidali", type: "def", ovr: 84, poste: "MC/AG", date: "J1 · 22 juin", stats: { VIT: 81, TIR: 80, PAS: 87, DRI: 88, DEF: 85, PHY: 80 } },
  { player: "Smail", type: "def", ovr: 84, poste: "MC/MDC", date: "J1 · 22 juin", stats: { VIT: 79, TIR: 78, PAS: 79, DRI: 79, DEF: 92, PHY: 93 } },
  { player: "Ilies", type: "mvp", ovr: 86, poste: "AD", date: "J3 · 6 juil.", stats: { VIT: 87, TIR: 85, PAS: 89, DRI: 92, DEF: 78, PHY: 81 } },
  { player: "Ilyes", type: "mvp", ovr: 83, poste: "MC/AT", date: "J3 · 6 juil.", stats: { VIT: 82, TIR: 91, PAS: 89, DRI: 93, DEF: 73, PHY: 67 } },
  { player: "Ilies", type: "impact", ovr: 86, poste: "AD", date: "J3 · 6 juil.", stats: { VIT: 87, TIR: 85, PAS: 89, DRI: 92, DEF: 78, PHY: 81 } },
  ...
  { player: "Anis", type: "def", ovr: 79, poste: "DC", date: "J3 · 6 juil.", stats: { VIT: 75, TIR: 80, PAS: 72, DRI: 73, DEF: 85, PHY: 88 } },
  { player: "Franz", type: "def", ovr: 82, poste: "MDC/MC", date: "J3 · 6 juil.", stats: { VIT: 79, TIR: 82, PAS: 78, DRI: 75, DEF: 88, PHY: 85 } },
  { player: "Moussa", type: "def", ovr: 84, poste: "DC/MDC", date: "J3 · 6 juil.", stats: { VIT: 80, TIR: 86, PAS: 78, DRI: 73, DEF: 93, PHY: 93 } },
  { player: "Yamin", type: "def", ovr: 85, poste: "MC/MDC", date: "J3 · 6 juil.", stats: { VIT: 90, TIR: 83, PAS: 84, DRI: 79, DEF: 83, PHY: 88 } },
  { player: "Ilyes", type: "mvp", ovr: 84, poste: "MC/AT", date: "J4 · 12 juil.", stats: { VIT: 82, TIR: 94, PAS: 92, DRI: 93, DEF: 73, PHY: 67 } },
  { player: "Wadi", type: "mvp", ovr: 84, poste: "AT", date: "J4 · 12 juil.", stats: { VIT: 89, TIR: 84, PAS: 86, DRI: 79, DEF: 81, PHY: 81 } },
  { player: "Badis", type: "impact", ovr: 84, poste: "MC/MDC", date: "J4 · 12 juil.", stats: { VIT: 78, TIR: 81, PAS: 78, DRI: 78, DEF: 91, PHY: 93 } },
  ...
  { player: "Anis", type: "def", ovr: 80, poste: "DC", date: "J4 · 12 juil.", stats: { VIT: 75, TIR: 81, PAS: 78, DRI: 73, DEF: 85, PHY: 88 } },
  { player: "Ayman", type: "def", ovr: 79, poste: "DD", date: "J4 · 12 juil.", stats: { VIT: 77, TIR: 74, PAS: 76, DRI: 75, DEF: 82, PHY: 85 } },
  { player: "Sofiane", type: "def", ovr: 82, poste: "AT", date: "J4 · 12 juil.", stats: { VIT: 87, TIR: 86, PAS: 76, DRI: 78, DEF: 82, PHY: 83 } },
  { player: "Wadi", type: "def", ovr: 85, poste: "AT", date: "J4 · 12 juil.", stats: { VIT: 91, TIR: 84, PAS: 86, DRI: 79, DEF: 83, PHY: 83 } },
  { player: "Anas", type: "mvp", ovr: 76, poste: "—", date: "J5 · 19 juil.", stats: { VIT: 75, TIR: 76, PAS: 77, DRI: 75, DEF: 75, PHY: 75 } },
  { player: "Ilyes", type: "mvp", ovr: 83, poste: "MC/AT", date: "J5 · 19 juil.", stats: { VIT: 82, TIR: 89, PAS: 91, DRI: 93, DEF: 73, PHY: 67 } },
  { player: "Jouneid", type: "mvp", ovr: 77, poste: "—", date: "J5 · 19 juil.", stats: { VIT: 75, TIR: 81, PAS: 77, DRI: 75, DEF: 75, PHY: 75 } },
  { player: "Adil Maimouni", type: "impact", ovr: 76, poste: "—", date: "J5 · 19 juil.", stats: { VIT: 75, TIR: 75, PAS: 76, DRI: 75, DEF: 75, PHY: 75 } },
  { player: "Anas", type: "impact", ovr: 76, poste: "—", date: "J5 · 19 juil.", stats: { VIT: 75, TIR: 76, PAS: 77, DRI: 75, DEF: 75, PHY: 75 } },
  { player: "Ilies", type: "impact", ovr: 85, poste: "AD", date: "J5 · 19 juil.", stats: { VIT: 87, TIR: 85, PAS: 86, DRI: 92, DEF: 78, PHY: 81 } },
  { player: "Ilyes", type: "impact", ovr: 83, poste: "MC/AT", date: "J5 · 19 juil.", stats: { VIT: 82, TIR: 89, PAS: 91, DRI: 93, DEF: 73, PHY: 67 } },
  { player: "Jouneid", type: "impact", ovr: 77, poste: "—", date: "J5 · 19 juil.", stats: { VIT: 75, TIR: 81, PAS: 77, DRI: 75, DEF: 75, PHY: 75 } },
  { player: "Kamil", type: "impact", ovr: 76, poste: "—", date: "J5 · 19 juil.", stats: { VIT: 75, TIR: 78, PAS: 77, DRI: 75, DEF: 75, PHY: 75 } },
  { player: "Anas", type: "def", ovr: 77, poste: "—", date: "J5 · 19 juil.", stats: { VIT: 77, TIR: 76, PAS: 77, DRI: 75, DEF: 77, PHY: 77 } },
  { player: "Badis", type: "def", ovr: 84, poste: "MC/MDC", date: "J5 · 19 juil.", stats: { VIT: 80, TIR: 79, PAS: 77, DRI: 78, DEF: 93, PHY: 95 } },
  { player: "Hassan Abdel", type: "def", ovr: 76, poste: "—", date: "J5 · 19 juil.", stats: { VIT: 77, TIR: 75, PAS: 75, DRI: 75, DEF: 77, PHY: 77 } },
  { player: "Sidali", type: "def", ovr: 84, poste: "MC/AG", date: "J5 · 19 juil.", stats: { VIT: 81, TIR: 80, PAS: 86, DRI: 88, DEF: 85, PHY: 80 } },
  { player: "Sofiane", type: "def", ovr: 83, poste: "AT", date: "J5 · 19 juil.", stats: { VIT: 87, TIR: 86, PAS: 79, DRI: 78, DEF: 82, PHY: 83 } },
  { player: "Sosso Abdel", type: "def", ovr: 76, poste: "—", date: "J5 · 19 juil.", stats: { VIT: 77, TIR: 75, PAS: 75, DRI: 75, DEF: 77, PHY: 77 } },
];
